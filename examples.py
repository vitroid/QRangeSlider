...
rs3.handle.setStyleSheet('background: url(data/sin.png) repeat; border: 0px;')
rs3.setStyleSheet("""
QRangeSlider > QSplitter::handle {
    background: #777;
...
# Example 1
rs1 = QRangeSlider(vertical=True)
rs1.show()
rs1.setWindowTitle('example 1')
rs1.setMin(10)
rs1.setMax(50)
...
# Example 2
rs2 = QRangeSlider(vertical=True)
rs2.show()
rs2.setWindowTitle('example 2')
rs2.setFixedWidth(36)
rs2.setFixedHeight(400)
rs2.setMin(0)
rs2.setMax(100)
rs2.setRange(30, 80)
rs2.setDrawValues(False)
...
# Example 3
rs3 = QRangeSlider(vertical=True)
rs3.show()
rs3.setWindowTitle('example 3')
rs3.setFixedWidth(50)
rs3.setMin(0)
rs3.setMax(2000)
rs3.setRange(500, 1253)
rs3.setBackgroundStyle('background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #aaa, stop:1 #777);')
